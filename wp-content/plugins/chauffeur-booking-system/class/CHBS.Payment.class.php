...
class CHBSPayment
{
    ...
    function __construct()
    {
        $this->payment=array
        (
            '1'                                                                 =>  array(__('Cash','chauffeur-booking-system')),
            '2'                                                                 =>  array(__('Stripe','chauffeur-booking-system')),
            '3'                                                                 =>  array(__('PayPal','chauffeur-booking-system')),
            '4'                                                                 =>  array(__('Wire transfer','chauffeur-booking-system'))
        );
    }
